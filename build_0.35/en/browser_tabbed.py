...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Version 0.35.113.EN"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About BlackBrowser", self)
        about_action.setStatusTip("Find out more about the BlackBrowser")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_blackware_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "Blacklinux Homepage", self)
        navigate_blackware_action.setStatusTip("Go to Blacklinux Homepage")
        ...
        self.setWindowTitle("BlackBrowser")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - BlackBrowser" % title)
...
app.setApplicationName("BlackBrowser")
